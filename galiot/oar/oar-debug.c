...
// uIP TCP/IP statistics
    ...
    {
        printf("[%8lu] DEBUG >   IP STATS >          (ip.recv) >                            received packets at the IP layer: (%10lu)\n",                                system_time, uip_stat.ip.recv);
        printf("[%8lu] DEBUG >   IP STATS >          (ip.sent) >                                sent packets at the IP layer: (%10lu)\n",                                    system_time, uip_stat.ip.sent);
        printf("[%8lu] DEBUG >   IP STATS >     (ip.forwarded) >                           forwarded packets at the IP layer: (%10lu)\n",                               system_time, uip_stat.ip.forwarded);
        printf("[%8lu] DEBUG >   IP STATS >          (ip.drop) >                             dropped packets at the IP layer: (%10lu)\n",                                 system_time, uip_stat.ip.drop);
        printf("[%8lu] DEBUG >   IP STATS >        (ip.vhlerr) >    packets dropped due to wrong IP version or header length: (%10lu)\n",        system_time, uip_stat.ip.vhlerr);
        printf("[%8lu] DEBUG >   IP STATS >      (ip.hblenerr) >           packets dropped due to wrong IP length, high byte: (%10lu)\n",               system_time, uip_stat.ip.hblenerr);
        printf("[%8lu] DEBUG >   IP STATS >      (ip.lblenerr) >            packets dropped due to wrong IP length, low byte: (%10lu)\n",                system_time, uip_stat.ip.lblenerr);
        printf("[%8lu] DEBUG >   IP STATS >       (ip.fragerr) >              packets dropped because they were IP fragments: (%10lu)\n",                  system_time, uip_stat.ip.fragerr);
        printf("[%8lu] DEBUG >   IP STATS >        (ip.chkerr) >                   packets dropped due to IP checksum errors: (%10lu)\n",                       system_time, uip_stat.ip.chkerr);
        printf("[%8lu] DEBUG >   IP STATS >      (ip.protoerr) > packets dropped because they were neither ICMP, UDP nor TCP: (%10lu)\n",     system_time, uip_stat.ip.protoerr);                  
    }
    ...
    {
        printf("[%8lu] DEBUG > ICMP STATS >        (icmp.recv) >                                       received ICMP packets: (%10lu)\n",               system_time, uip_stat.icmp.recv);
        printf("[%8lu] DEBUG > ICMP STATS >        (icmp.sent) >                                           sent ICMP packets: (%10lu)\n",                   system_time, uip_stat.icmp.sent);
        printf("[%8lu] DEBUG > ICMP STATS >        (icmp.drop) >                                        dropped ICMP packets: (%10lu)\n",                system_time, uip_stat.icmp.drop);
        printf("[%8lu] DEBUG > ICMP STATS >     (icmp.typeerr) >                              ICMP packets with a wrong type: (%10lu)\n",      system_time, uip_stat.icmp.typeerr);
        printf("[%8lu] DEBUG > ICMP STATS >      (icmp.chkerr) >                            ICMP packets with a bad checksum: (%10lu)\n",    system_time, uip_stat.icmp.chkerr);
    ...
    // ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
        ...
        {
            printf("[%8lu] DEBUG >  TCP STATS >         (tcp.recv) >                                       received TCP segments: (%10lu)\n",                                       system_time, uip_stat.tcp.recv);
            printf("[%8lu] DEBUG >  TCP STATS >         (tcp.sent) >                                           sent TCP segments: (%10lu)\n",                                           system_time, uip_stat.tcp.sent);
            printf("[%8lu] DEBUG >  TCP STATS >         (tcp.drop) >                                        dropped TCP segments: (%10lu)\n",                                        system_time, uip_stat.tcp.drop);
            printf("[%8lu] DEBUG >  TCP STATS >       (tcp.chkerr) >                            TCP segments with a bad checksum: (%10lu)\n",                            system_time, uip_stat.tcp.chkerr);
            printf("[%8lu] DEBUG >  TCP STATS >       (tcp.ackerr) >                          TCP segments with a bad ACK number: (%10lu)\n",                          system_time, uip_stat.tcp.ackerr);
            printf("[%8lu] DEBUG >  TCP STATS >          (tcp.rst) >                           received TCP RST (reset) segments: (%10lu)\n",                           system_time, uip_stat.tcp.rst);
            printf("[%8lu] DEBUG >  TCP STATS >       (tcp.rexmit) >                                  retransmitted TCP segments: (%10lu)\n",                                  system_time, uip_stat.tcp.rexmit);
            printf("[%8lu] DEBUG >  TCP STATS >      (tcp.syndrop) >     dropped SYNs because too few connections were available: (%10lu)\n",     system_time, uip_stat.tcp.syndrop);
            printf("[%8lu] DEBUG >  TCP STATS >       (tcp.synrst) >                     SYNs for closed ports, triggering a RST: (%10lu)\n",                     system_time, uip_stat.tcp.synrst);
        }
    ...
    // ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
        ...
        {
            printf("[%8lu] DEBUG >  UDP STATS >         (udp.drop) >                                        dropped UDP segments: (%10lu)\n",                system_time, uip_stat.udp.drop);
            printf("[%8lu] DEBUG >  UDP STATS >         (udp.recv) >                                       received UDP segments: (%10lu)\n",               system_time, uip_stat.udp.recv);
            printf("[%8lu] DEBUG >  UDP STATS >         (udp.sent) >                                           sent UDP segments: (%10lu)\n",                   system_time, uip_stat.udp.sent);
            printf("[%8lu] DEBUG >  UDP STATS >       (udp.chkerr) >                            UDP segments with a bad checksum: (%10lu)\n",    system_time, uip_stat.udp.chkerr);
        }
    ...
    {
        printf("[%8lu] DEBUG >  ND6 STATS >         (nd6.drop) >                                         dropped ND6 packets: (%10lu)\n", system_time, uip_stat.nd6.drop);
        printf("[%8lu] DEBUG >  ND6 STATS >         (nd6.recv) >                                         dropped ND6 packets: (%10lu)\n", system_time, uip_stat.nd6.recv);
        printf("[%8lu] DEBUG >  ND6 STATS >         (nd6.sent) >                                         dropped ND6 packets: (%10lu)\n", system_time, uip_stat.nd6.sent);
    }
...
// ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    void oar_debug_cmd_rpl_status(unsigned long int system_time)
    {
        ...
        else 
        {
            ...
            printf("[%8lu] DEBUG >      SHELL >   (cmd_rpl_status) >                                                         DAG: ", system_time);
                oar_debug_ipaddr_to_str(oar_ipaddr, &curr_instance.dag.dag_id); printf("%s", oar_ipaddr);
                printf(", version %u\n", curr_instance.dag.version);

            printf("[%8lu] DEBUG >      SHELL >   (cmd_rpl_status) >                                                      Prefix: ", system_time);
            ...
            printf("[%8lu] DEBUG >      SHELL >   (cmd_rpl_status) >                                            Preferred parent: ", system_time);
...
{
    printf("[%8lu] DEBUG >      SHELL >       (cmd_macaddr) >                                            Node MAC address: ", system_time);
...
// ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    void oar_debug_cmd_ipaddr(unsigned long int system_time)
    {
        ...
        for(int i = 0; i < UIP_DS6_ADDR_NB; i++) 
        {
            ...
            {
                printf("[%8lu] DEBUG >      SHELL >       (cmd_ipaddr) >                                         Node IPv6 addresses: ", system_time);
    ...
    void oar_debug_cmd_ip_neighbors(unsigned long int system_time)
    {
        ...
        else
        {
            while(nbr != NULL) 
            {
                ...
                printf("[%8lu] DEBUG >      SHELL > (cmd_ip_neighbors) >                                       Node IPv6 neighbor %d: ", system_time, oar_ip_neighbor_count);
...
// ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    void oar_debug_cmd_tsch_status(unsigned long int system_time)
    {
        ...
        if(tsch_is_associated) 
        {
            ...
            printf("[%8lu] DEBUG >      SHELL >  (cmd_tsch_status) >                                             Time source: ", system_time);
            if(n != NULL) 
            {
...
// ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    void oar_debug_cmd_routes(unsigned long int system_time)
    {
        ...
        {
            printf("[%8lu] DEBUG >      SHELL >       (cmd_routes) >                                              Default route: ", system_time);
        ...
        // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            ...
            {
                printf("[%8lu] DEBUG >      SHELL >       (cmd_routes) >                                              Routing links: None\n", system_time);
            }
        ...
        // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            ...
            {
                printf("[%8lu] DEBUG >      SHELL >       (cmd_routes) >                                             Routing entries: None\n", system_time);
            }
