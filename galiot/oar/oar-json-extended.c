...
// ######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)########
    ...
    static const char *oar_json_extended_ds6_nbr_state_to_str(uint8_t state)
    {
        switch(state) 
        {
...
// ######## (ROUTING_CONF_RPL_LITE)######## (ROUTING_CONF_RPL_LITE)######## (ROUTING_CONF_RPL_LITE)######## (ROUTING_CONF_RPL_LITE)######## (ROUTING_CONF_RPL_LITE)######## (ROUTING_CONF_RPL_LITE)########
    ...
    static const char *oar_json_extended_rpl_state_to_str(enum rpl_dag_state state)
    {
        switch(state) 
        {
    ...
    static const char *oar_json_extended_rpl_mop_to_str(int mop)
    {
        switch(mop) 
        {
    ...
    static const char *oar_json_extended_rpl_ocp_to_str(int ocp)
    {
        switch(ocp) 
        {
...
// ######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)########
    ...
    static void oar_json_extended_ipaddr_to_str(char *output, const uip_ipaddr_t *ipaddr) 
    {
...
static void oar_json_extended_lladdr_to_str(char *output, const linkaddr_t *lladdr) 
{
...
// #########(ENERGEST_CONF_ON)#########(ENERGEST_CONF_ON)#########(ENERGEST_CONF_ON)#########(ENERGEST_CONF_ON)#########(ENERGEST_CONF_ON)#########(ENERGEST_CONF_ON)#########(ENERGEST_CONF_ON))#########
    ...
    static unsigned long oar_json_extended_to_seconds(uint64_t time)
    {
...
// char oar_json_extended_buf[OAR_CONF_JSON_BUF_SIZE];    // global string: will contain the json

// ----------------------------------------------------------------------------

void oar_json_extended_print(char * buf)
{
    printf("%s\n", buf);
}
...
// ######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)########
     ...
     static char oar_json_extended_ipaddr[UIPLIB_IPV6_MAX_STR_LEN];

#endif //(NETSTACK_CONF_WITH_IPV6)
// ######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)########

static char oar_json_extended_lladdr[UIPLIB_IPV6_MAX_STR_LEN];
...
static void oar_json_extended_init(char * buf)
{
...
static void oar_json_extended_enter(char * buf)
{
    char str[128];
...
static void oar_json_extended_bridge(char * buf)
{
    char str[128];
    sprintf(str,    "," );  strcat(buf, str);
}
...
static void oar_json_extended_exit(char * buf)
{
    char str[128];
    sprintf(str,    "}" );  strcat(buf, str);
}
...
static void oar_json_extended_append_system(char * buf)
{
    char str[128];
    ...
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        oar_json_extended_lladdr_to_str(oar_json_extended_lladdr, &linkaddr_node_addr);
        sprintf(str, "\"" "linkLayerAddress" "\"" ":" "\"" "%s" "\"" ,oar_json_extended_lladdr ); strcat(buf, str);  sprintf(str, ","); strcat(buf, str);
        ...
        // #########(NETSTACK_CONF_WITH_IPV6)#########(NETSTACK_CONF_WITH_IPV6)#########(NETSTACK_CONF_WITH_IPV6)#########(NETSTACK_CONF_WITH_IPV6)#########(NETSTACK_CONF_WITH_IPV6)#########(NETSTACK_CONF_WITH_IPV6)#########
            ...
            oar_json_extended_ipaddr_to_str(oar_json_extended_ipaddr, lladdr != NULL ? &lladdr->ipaddr : NULL);
            sprintf(str, "\""    "TentativeLinkLocalIPv6address" "\"" ":" "\""  "%s"    "\"" ,oar_json_extended_ipaddr   ); strcat(buf, str);
...
static void oar_json_extended_append_id(char * buf)
{
    char str[128];
...
static void oar_json_extended_append_energy(char * buf)
{
    char str[128];
    ...
    // #########(ENERGEST_CONF_ON)#########(ENERGEST_CONF_ON)#########(ENERGEST_CONF_ON)#########(ENERGEST_CONF_ON)#########(ENERGEST_CONF_ON)#########(ENERGEST_CONF_ON)#########(ENERGEST_CONF_ON)#########
        ...
        // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            ...
            sprintf(str, "\"" "cpu"           "\"" ":" "%lu"   ,oar_json_extended_to_seconds(energest_type_time(ENERGEST_TYPE_CPU))                                                                                );  strcat(buf, str); sprintf(str,","); strcat(buf, str);
            sprintf(str, "\"" "lpm"           "\"" ":" "%lu"   ,oar_json_extended_to_seconds(energest_type_time(ENERGEST_TYPE_LPM))                                                                                );  strcat(buf, str); sprintf(str,","); strcat(buf, str);
            sprintf(str, "\"" "deepLpm"       "\"" ":" "%lu"   ,oar_json_extended_to_seconds(energest_type_time(ENERGEST_TYPE_DEEP_LPM))                                                                           );  strcat(buf, str); sprintf(str,","); strcat(buf, str);
            sprintf(str, "\"" "totalTime"     "\"" ":" "%lu"   ,oar_json_extended_to_seconds(ENERGEST_GET_TOTAL_TIME())                                                                                            );  strcat(buf, str); sprintf(str,","); strcat(buf, str);
            sprintf(str, "\"" "radioListen"   "\"" ":" "%lu"   ,oar_json_extended_to_seconds(energest_type_time(ENERGEST_TYPE_LISTEN))                                                                             );  strcat(buf, str); sprintf(str,","); strcat(buf, str);
            sprintf(str, "\"" "radioTransmit" "\"" ":" "%lu"   ,oar_json_extended_to_seconds(energest_type_time(ENERGEST_TYPE_TRANSMIT))                                                                           );  strcat(buf, str); sprintf(str,","); strcat(buf, str);
            sprintf(str, "\"" "radioOff"      "\"" ":" "%lu"   ,oar_json_extended_to_seconds(ENERGEST_GET_TOTAL_TIME() - energest_type_time(ENERGEST_TYPE_TRANSMIT) - energest_type_time(ENERGEST_TYPE_LISTEN))    );  strcat(buf, str); 
...
static void oar_json_extended_append_stats(char * buf)
{
    char str[128];
...
static void oar_json_extended_append_net(char * buf)
{
    char str[128];
        ...
        // ######## (ROUTING_CONF_RPL_LITE)######## (ROUTING_CONF_RPL_LITE)######## (ROUTING_CONF_RPL_LITE)######## (ROUTING_CONF_RPL_LITE)######## (ROUTING_CONF_RPL_LITE)######## (ROUTING_CONF_RPL_LITE)########
            ...
            // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                ...
                else
                {
                    ...
                    int oar_json_extended_rpl_neighbor_count = 0;
                    ...
                    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    
                        ...
                        while(nbr != NULL)
                        {
                            oar_json_extended_rpl_neighbor_count++; 
                            
                            rpl_nbr_t *oar_json_extended_rpl_nbr_best = best_parent(0);
                            const struct link_stats *oar_json_extended_rpl_nbr_stats = rpl_neighbor_get_link_stats(nbr);
                            clock_time_t oar_json_extended_rpl_nbr_clock_now = clock_time();

                            // {{{{{{{{{{{{{{{{{}}}}}}}}}}}}}}}}}
                            sprintf(str, "{" ); strcat(buf, str);

                                oar_json_extended_ipaddr_to_str(oar_json_extended_ipaddr, rpl_neighbor_get_ipaddr(nbr));
                                sprintf(str, "\"" "ipAddr"                              "\"" ":" "\""   "%s"    "\""       ,oar_json_extended_ipaddr); strcat(buf, str); sprintf(str, ","); strcat(buf, str);
                                ...
                                sprintf(str, "\"" "freshStats"                  "\"" ":"                "%2u"              ,oar_json_extended_rpl_nbr_stats != NULL ? oar_json_extended_rpl_nbr_stats->freshness : 0                                              ); strcat(buf, str);    sprintf(str, ","); strcat(buf, str);
                                sprintf(str, "\"" "rootRank"                    "\"" ":"                "%s"               ,(nbr->rank == ROOT_RANK) ? "true" : "false"                                                                         ); strcat(buf, str);    sprintf(str, ","); strcat(buf, str);
                                sprintf(str, "\"" "bestNbr"                     "\"" ":"                "%s"               ,nbr == oar_json_extended_rpl_nbr_best ? "true" : "false"                                                                     ); strcat(buf, str);    sprintf(str, ","); strcat(buf, str);
                                ...
                                if(oar_json_extended_rpl_nbr_stats->last_tx_time > 0) 
                                {
                                    sprintf(str, "\"" "lastTxMinutesAgo"        "\"" ":"                "%u"                ,(unsigned)((oar_json_extended_rpl_nbr_clock_now - oar_json_extended_rpl_nbr_stats->last_tx_time) / (60 * CLOCK_SECOND))              ); strcat(buf, str);    sprintf(str, ","); strcat(buf, str);
                                }
                                else
                                {
                                    sprintf(str, "\"" "lastTxMinutesAgo"        "\"" ":"                "null"                                                                                                                                  ); strcat(buf, str);    sprintf(str, ","); strcat(buf, str);
                                ...
                                {
                                    sprintf(str, "\"" "betterParentSinceMinute" "\"" ":"                "%u"           ,(unsigned)((oar_json_extended_rpl_nbr_clock_now - nbr->better_parent_since) / (60 * CLOCK_SECOND))                               ); strcat(buf, str);   
                                }
                                else
                                {
                                    sprintf(str, "\"" "betterParentSinceMinute" "\"" ":"                "null"                                                                                                                                  ); strcat(buf, str);  
                            ...
                            if (oar_json_extended_rpl_neighbor_count < NBR_TABLE_CONF_MAX_NEIGHBORS) { sprintf(str, ","); strcat(buf, str); }
                            nbr = nbr_table_next(rpl_neighbors, nbr);
                        }
                        
                        for (int i = oar_json_extended_rpl_neighbor_count; i < NBR_TABLE_CONF_MAX_NEIGHBORS; i++)
                        {
            ...
            // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                ...
                { 
                    ...
                    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                        ...
                        oar_json_extended_ipaddr_to_str(oar_json_extended_ipaddr, &curr_instance.dag.dag_id);
                        sprintf(str, "\"" "dagId"           "\"" ":" "\""   "%s"    "\""    ,oar_json_extended_ipaddr                                        ); strcat(buf, str);    sprintf(str, ","); strcat(buf, str);
                        
                        sprintf(str, "\"" "dagVersion"      "\"" ":"        "%u"            ,curr_instance.dag.version                              ); strcat(buf, str);    sprintf(str, ","); strcat(buf, str);

                        oar_json_extended_ipaddr_to_str(oar_json_extended_ipaddr, &curr_instance.dag.prefix_info.prefix);
                        sprintf(str, "\"" "dagPrefix"       "\"" ":" "\""   "%s"    "\""    ,oar_json_extended_ipaddr                                        ); strcat(buf, str);    sprintf(str, ","); strcat(buf, str);
                        
                        sprintf(str, "\"" "dagPrefixLength" "\"" ":"        "%u"            ,curr_instance.dag.prefix_info.length                   ); strcat(buf, str);    sprintf(str, ","); strcat(buf, str);
                        sprintf(str, "\"" "state"           "\"" ":" "\""   "%s"    "\""    ,oar_json_extended_rpl_state_to_str(curr_instance.dag.state)     ); strcat(buf, str);    sprintf(str, ","); strcat(buf, str);

                        if (curr_instance.dag.preferred_parent) 
                        {
                            oar_json_extended_ipaddr_to_str(oar_json_extended_ipaddr, rpl_neighbor_get_ipaddr(curr_instance.dag.preferred_parent));
                            sprintf(str, "\"" "preferredParent" "\"" ":" "\"" "%s"      "\""    ,oar_json_extended_ipaddr    ); strcat(buf, str);    sprintf(str, "," ); strcat(buf, str);
                        }
                        else
                        {
                    ...
                    sprintf(str, "\"" "mop"                 "\"" ":" "\""   "%s"    "\""    ,oar_json_extended_rpl_mop_to_str(curr_instance.mop)     ); strcat(buf, str);    sprintf(str, "," ); strcat(buf, str);
                    sprintf(str, "\"" "of"                  "\"" ":" "\""   "%s"    "\""    ,oar_json_extended_rpl_ocp_to_str(curr_instance.of->ocp) ); strcat(buf, str);    sprintf(str, "," ); strcat(buf, str);
    ...
    oar_json_extended_lladdr_to_str(oar_json_extended_lladdr, &linkaddr_node_addr);
    sprintf(str, "\"" "nodeMacAddress" "\"" ":" "\"" "%s" "\"" ,oar_json_extended_lladdr); strcat(buf, str); sprintf(str, ","); strcat(buf, str);
    ...
    // ######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)######## (NETSTACK_CONF_WITH_IPV6)########
        ...
        // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            ...
            uint8_t state;
            int oar_json_extended_ipaddr_count = 0;
            ...
            // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                ...
                for(int i = 0; i < UIP_DS6_ADDR_NB; i++) 
                {
                    ...
                    {
                        oar_json_extended_ipaddr_count++;
                        
                        oar_json_extended_ipaddr_to_str(oar_json_extended_ipaddr, &uip_ds6_if.addr_list[i].ipaddr);
                        sprintf(str, "\"" "%s"      "\"" ,oar_json_extended_ipaddr   ); strcat(buf, str);
            ...
            sprintf(str,    "\""    "addrIssuedCount"           "\""    ":" "%u"    ,oar_json_extended_ipaddr_count                               );  strcat(buf, str);   // sprintf(str,    "," );  strcat(buf, str);
        ...
        // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            ...
            uip_ds6_nbr_t *nbr;
            int oar_json_extended_ip_neighbor_count = 0;
            ...
            if(nbr == NULL)
            {
                ...
                sprintf(str,    "\""    "ipNbrCount"    "\""    ":" "%u"    ,oar_json_extended_ip_neighbor_count );  strcat(buf, str); 
            }
            else
            {
                ...
                // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                        ...
                        while(nbr != NULL)
                        {
                            oar_json_extended_ip_neighbor_count++;
                            
                            // {{{{{{{{{{{{{{{{{}}}}}}}}}}}}}}}}}
                            sprintf(str, "{"); strcat(buf, str);
                            
                                oar_json_extended_ipaddr_to_str(oar_json_extended_ipaddr, uip_ds6_nbr_get_ipaddr(nbr));
                                sprintf(str,    "\""    "ipAddr"    "\""    ":" "\""    "%s"    "\""    ,oar_json_extended_ipaddr                            ); strcat(buf, str);    sprintf(str, ",");  strcat(buf, str);

                                oar_json_extended_lladdr_to_str(oar_json_extended_lladdr, (linkaddr_t *)uip_ds6_nbr_get_ll(nbr));
                                sprintf(str,    "\""    "llAddr"    "\""    ":" "\""    "%s"    "\""    ,oar_json_extended_lladdr                            ); strcat(buf, str);    sprintf(str, ",");  strcat(buf, str);

                                sprintf(str,    "\""    "router"    "\""    ":"         "%u"            ,nbr->isrouter                              ); strcat(buf, str);    sprintf(str, ",");  strcat(buf, str);
                                sprintf(str,    "\""    "state"     "\""    ":" "\""    "%s"    "\""    ,oar_json_extended_ds6_nbr_state_to_str(nbr->state)  ); strcat(buf, str);

                            sprintf(str, "}"); strcat(buf, str);
                            // {{{{{{{{{{{{{{{{{}}}}}}}}}}}}}}}}}

                            if (oar_json_extended_ip_neighbor_count != NBR_TABLE_CONF_MAX_NEIGHBORS) { sprintf(str, "," );  strcat(buf, str); }
                            
                            nbr = uip_ds6_nbr_next(nbr);
                        }

                        for (int j = oar_json_extended_ip_neighbor_count; j < NBR_TABLE_CONF_MAX_NEIGHBORS; j++)
                        {
        ...
        // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            ...
            {
                oar_json_extended_ipaddr_to_str(oar_json_extended_ipaddr, &default_route->ipaddr);
                sprintf(str,    "\""        "defaultRoute"      "\""        ":"     "\""        "%s"        "\""        ,oar_json_extended_ipaddr        );  strcat(buf, str);   sprintf(str, "," );  strcat(buf, str);
            ...
            // ######## (NETSTACK_CONF_WITH_IPV6)> (UIP_CONF_IPV6_RPL)######## (NETSTACK_CONF_WITH_IPV6)> (UIP_CONF_IPV6_RPL)######## (NETSTACK_CONF_WITH_IPV6)> (UIP_CONF_IPV6_RPL)######## (NETSTACK_CONF_WITH_IPV6)> (UIP_CONF_IPV6_RPL)######## 
                ...
                int oar_json_extended_uip_sr_links_count = 0;
                ...
                if (uip_sr_num_nodes() > 0)
                {
                    ...
                    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                        ...
                        for (int j = oar_json_extended_uip_sr_links_count; j < NBR_TABLE_CONF_MAX_NEIGHBORS; j++)
                        {
                    ...
                    sprintf(str,    "\""    "uipSrLinkCount"    "\""    ":" "%u"    ,oar_json_extended_uip_sr_links_count );  strcat(buf, str); 
            ...
            // ######## (NETSTACK_CONF_WITH_IPV6)> (UIP_MAX_ROUTES != 0)######## (NETSTACK_CONF_WITH_IPV6)> (UIP_MAX_ROUTES != 0)######## (NETSTACK_CONF_WITH_IPV6)> (UIP_MAX_ROUTES != 0)######## (NETSTACK_CONF_WITH_IPV6)> (UIP_MAX_ROUTES != 0)######## 
                ...
                // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                    ...
                    if(uip_ds6_route_num_routes() > 0)
                    {
                        ...
                        int oar_json_extended_ds6_route_count = 0;
                        ...
                        while(route != NULL) 
                        {
                            oar_json_extended_ds6_route_count++;

                            // {{{{{{{{{{{{{{{{{}}}}}}}}}}}}}}}}}
                            sprintf(str, "{"); strcat(buf, str);

                                oar_json_extended_ipaddr_to_str(oar_json_extended_ipaddr, &route->ipaddr);
                                sprintf(str,    "\""    "route"     "\""    ":" "\""    "%s"    "\""    ,oar_json_extended_ipaddr); strcat(buf, str);    sprintf(str, "," );  strcat(buf, str);

                                oar_json_extended_ipaddr_to_str(oar_json_extended_ipaddr, uip_ds6_route_nexthop(route));
                                sprintf(str,    "\""    "via"       "\""    ":" "\""    "%s"    "\""    ,oar_json_extended_ipaddr); strcat(buf, str);    sprintf(str, "," );  strcat(buf, str);
                            ...
                            if (oar_json_extended_ds6_route_count != NBR_TABLE_CONF_MAX_NEIGHBORS)    { sprintf(str, "," );  strcat(buf, str); }
                        }

                        for (int j = oar_json_extended_ds6_route_count; j < NBR_TABLE_CONF_MAX_NEIGHBORS; j++)
                        {
...
{
    oar_json_extended_init(buf);
    oar_json_extended_enter(buf);
    oar_json_extended_append_system(buf);
    oar_json_extended_bridge(buf);
    oar_json_extended_append_id(buf);
    oar_json_extended_bridge(buf);
    oar_json_extended_append_energy(buf);
    oar_json_extended_bridge(buf);
    oar_json_extended_append_stats(buf);
    oar_json_extended_bridge(buf);
    oar_json_extended_append_net(buf);
    oar_json_extended_exit(buf);
}
