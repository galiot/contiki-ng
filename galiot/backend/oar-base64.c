...
// MODIFICATION
//
// The following, original encoding function allocates b64_encoded_size(len) bytes 
// and return them to itself, making it impossible to free them outside the scope.
//
// ---------------------------------------------------------------------------
// ORIGINAL char *oar_base64_encode(const char *in, size_t len) FUNCTION /////
// ---------------------------------------------------------------------------
//
// char *oar_base64_encode(const char *in, size_t len)
// {
// 	char   *out;
// 	size_t  elen;
// 	size_t  i;
